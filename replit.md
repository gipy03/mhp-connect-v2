...
- `POST /api/admin/sync/channels` — auto-create forum channels for allowed program categories + cleanup excess; `ensureChannelsForAllPrograms()` + `ensureChannelsForAllSessions()` + `cleanupNonAllowedChannels()`
